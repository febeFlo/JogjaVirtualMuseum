        ...
        <div class="max-w-lg p-6 bg-white my-[4%] mx-[5%] rounded-lg shadow-md">
            ...
            <form action="{{ route('submit1') }}" method="POST">
                ...
                <div class="flex items-center justify-center mt-3">
                    <textarea id="text" name="text" rows="2" class="w-full px-1 my-2 text-sm text-gray-900 bg-white border-1 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Tuliskan lokasi iconic yang menurut anda perlu ditambah. Gunakan (,) jika lebih dari 1">{{ $getSelected->additional_locations ?? '' }}</textarea>
                </div>
